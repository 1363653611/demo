...
//        testGetGroupId(jsonStr, mapper);
    ...
    private static JsonNode testPutCrmId( ObjectMapper mapper){
        ...
        try {
            ...
            JsonNode phone = jsonNode.findValue("phone");
    ...
    private static JsonNode testInventoryStatus( ObjectMapper mapper){
        String status = getStatus();
        try {
            JsonNode jsonNode = mapper.readTree(status);

            JsonNode at = jsonNode.at("/inventoryStatus");
    ...
    public static String getStatus(){
        return "{\"ok\":true,\"errorCode\":\"2000\",\"errorMsg\":\"处理成功\",\"data\":{\"id\":\"5bface100c234000012a4a26\",\"vehicleId\":\"5bf605410045720019fadc62\",\"unifiedNumber\":\"000536661\",\"merchantId\":\"5bd17c6d20000092004e2dab\",\"groupId\":\"5970bca3130000225ce66442\",\"inventoryStatus\":\"pending\",\"createdAt\":\"2018-11-26T00:30:08.037+08:00\",\"updateAt\":\"2018-11-26T19:30:02.906+08:00\"}}";
    }
